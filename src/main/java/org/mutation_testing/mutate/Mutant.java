...
public class Mutant {
    ...
    protected Expression mutationCondition;
    ...
    public Expression getMutationCondition() {
    ...
    public Mutant(int mid, Source source, Node originalNode, Node replNode, Expression mutationCondition) {
        this.mid = mid;
        this.source = source;
